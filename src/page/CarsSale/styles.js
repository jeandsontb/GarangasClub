...
export const HeadCarSale = styled.header`
...
export const SaleImgIndex = styled.img`
    width: 500px;
    height: 320px;
    object-fit: cover;
    border-radius: 10px;
...
export const SaleButtonThumb = styled.button`
    background: none;
    overflow: hidden;
    outline: none;
    border: 0;
...
export const SaleButtonThumbImage = styled.img`
    width: 60px;
    height: 70px;
    object-fit: cover;
    border-radius: 5px;
...
export const SaleBodyTitle = styled.h2`
    text-align: center;
    font-family: McLaren;
    color: var(--blue-strong);
    margin-top: 10px;
...
export const SaleBodyDescription = styled.p`
    font-family: Roboto;
...
export const SaleBodyPhone = styled.p`
    font-family: Roboto;
    color: var(--brown-active);
    margin-top: 30px;
...
export const SaleBodyPrice = styled.p`
    font-family: Roboto;
    color: var(--brown-active);
    margin-top: 20px;
`;
